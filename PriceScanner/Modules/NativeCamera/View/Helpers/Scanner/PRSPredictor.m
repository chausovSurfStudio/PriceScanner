...
@implementation PRSPredictor

- (PRSScannerPrediction *)predictNameWithSessions:(NSArray<PRSSingleScanSession *> *)rawSessions {
    NSArray<PRSSingleScanSession *> *sessions = [self selectSessionsForBuildingName:rawSessions];
...
- (PRSScannerPrediction *)predictPriceWithSessions:(NSArray<PRSSingleScanSession *> *)rawSessions {
    NSArray<PRSSingleScanSession *> *sessions = [self selectSessionsForBuildingPrice:rawSessions];
